...
%%%-----------------------------------------------------------------------------
-module(erldist_filter_test_p2p_sup).
-moduledoc """
""".
...
-spec start_child(OwnerPid, Label, Setup, Teardown) -> StartChildReturn when
    OwnerPid :: pid(),
    Label :: erldist_filter_test_p2p:label(),
...
init({}) ->
    ...
    ChildSpecs = [
        erldist_filter_test_p2p:child_spec()
    ],
