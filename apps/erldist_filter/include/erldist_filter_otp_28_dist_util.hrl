%% NOTE: This file is imported from https://raw.githubusercontent.com/erlang/otp/refs/heads/maint-28/lib/kernel/include/dist_util.hrl
%% @oncall whatsapp_clr
...
-define(shutdown(Data), erldist_filter_otp_28_dist_util:shutdown(?MODULE, ?LINE, Data)).
-define(shutdown2(Data, Reason), erldist_filter_otp_28_dist_util:shutdown(?MODULE, ?LINE, Data, Reason)).
