...
static C11THREADS_INLINE thrd_t
thrd_current(void)
{
    return pthread_self();
}
...
static C11THREADS_INLINE int
thrd_sleep(const struct timespec *ts_in, struct timespec *rem_out)
{
...
thrd_sleep(const struct timespec *ts_in, struct timespec *rem_out)
{
    if (sizeof(ts_in->tv_sec) == 4) {
        return _c11threads_win32_thrd_sleep32((const struct _c11threads_win32_timespec32_t *)ts_in,
                                              (struct _c11threads_win32_timespec32_t *)rem_out);
    } else {
        return _c11threads_win32_thrd_sleep64((const struct _c11threads_win32_timespec64_t *)ts_in,
                                              (struct _c11threads_win32_timespec64_t *)rem_out);
    }
}
