...
// @generated SignedSource<<226c33e86005e90dd5693e82f38e664c>>
/*
...
#define BLOCK_NAME(atom)                                                                                                           \
    ...
    if (!atomic_flag_test_and_set(&edf_otp_name_blocklist_initialized)) {
        if (edf_otp_name_blocklist->hs == NULL) {
            ...
            BLOCK_NAME(ATOM(cover_server));
            BLOCK_NAME(ATOM(cpu_sup));
            BLOCK_NAME(ATOM(crashdump_viewer));
            BLOCK_NAME(ATOM(crashdump_viewer_server));
            ...
            BLOCK_NAME(ATOM(et_collector));
            BLOCK_NAME(ATOM(eunit_server));
            BLOCK_NAME(ATOM(file_server));
            BLOCK_NAME(ATOM(file_server_2));
            BLOCK_NAME(ATOM(fprof_server));
            ...
            BLOCK_NAME(ATOM(heart));
            BLOCK_NAME(ATOM(heart_port));
            ...
            BLOCK_NAME(ATOM(pool_master));
            BLOCK_NAME(ATOM(rb_server));
            BLOCK_NAME(ATOM(release_handler));
            BLOCK_NAME(ATOM(rex_proxy_user));
            ...
            BLOCK_NAME(ATOM(snmpm_server_cbproxy));
            BLOCK_NAME(ATOM(snmpm_server_nis));
...
{
#define NUMBER_OF_OTP_NAME_BLOCKLIST (201)
    ...
    atoms[i++] = ATOM(cover_server);
    atoms[i++] = ATOM(cpu_sup);
    atoms[i++] = ATOM(crashdump_viewer);
    atoms[i++] = ATOM(crashdump_viewer_server);
    ...
    atoms[i++] = ATOM(et_collector);
    atoms[i++] = ATOM(eunit_server);
    atoms[i++] = ATOM(file_server);
    atoms[i++] = ATOM(file_server_2);
    atoms[i++] = ATOM(fprof_server);
    ...
    atoms[i++] = ATOM(pool_master);
    atoms[i++] = ATOM(rb_server);
    atoms[i++] = ATOM(release_handler);
    atoms[i++] = ATOM(rex_proxy_user);
    ...
    atoms[i++] = ATOM(snmpm_server_cbproxy);
    atoms[i++] = ATOM(snmpm_server_nis);
