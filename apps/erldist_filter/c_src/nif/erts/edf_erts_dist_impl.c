...
// @generated SignedSource<<0a00dd015a3c2455d94ab367c0fde77b>>
/*
...
{
#define NUMBER_OF_DISTRIBUTION_FLAGS (45)
    ...
    keys[k++] = ATOM(DFLAG_NATIVE_RECORDS);
    vals[v++] = enif_make_uint64(env, DFLAG_NATIVE_RECORDS);
