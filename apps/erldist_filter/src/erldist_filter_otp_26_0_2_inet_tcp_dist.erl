%% NOTE: This file is imported from https://raw.githubusercontent.com/erlang/otp/OTP-26.0.2/lib/kernel/src/inet_tcp_dist.erl
...
%% %CopyrightEnd%
%%
-module(erldist_filter_otp_26_0_2_inet_tcp_dist).
...
fam_select(Family, Node) ->
    case erldist_filter_otp_26_0_2_dist_util:split_node(Node) of
	{node, Name, Host} ->
...
do_accept(Driver, Kernel, AcceptPid, Socket, MyNode, Allowed, SetupTime) ->
	...
	{AcceptPid, controller} ->
	    Timer = erldist_filter_otp_26_0_2_dist_util:start_timer(SetupTime),
		...
		true ->
		    ...
		    erldist_filter_otp_26_0_2_dist_util:handshake_other_started(HSData);
		{false,IP} ->
...
do_setup(Driver, Kernel, Node, Type, MyNode, LongOrShortNames, SetupTime) ->
    ...
    erldist_filter_otp_26_0_2_dist_util:reset_timer(Timer),
    case Driver:connect(Ip, TcpPort, ConnectOptions) of
        {ok, Socket} ->
            ...
            erldist_filter_otp_26_0_2_dist_util:handshake_we_started(HSData);
        _ ->
